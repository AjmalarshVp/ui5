                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Row(
                          children: [
                            SizedBox(height: 17,width: 20,child: DecoratedBox(decoration: BoxDecoration(color: Colors.blue[100],borderRadius: BorderRadius.circular(3),border: Border.all(color: Colors.blue.shade900)),child: Center(child: CustomText(text: '1',color: Colors.blue[900],size: 11,)),),),
                            SizedBox(width: 10,),
